...
An exploratory data analytics project focused on UPI transaction behavior, transaction trends, merchant activity, customer patterns, and fraud patterns using Python, Pandas, SQL, MySQL, and Power BI.
...
The Power BI dashboard provides an interactive visual analysis of UPI transactions, covering transaction volume, transaction status, transaction amount, user demographics, merchant categories, device distribution, and fraud analysis.
...
│
├── Dashboard/
│   └── UPI_Transaction_Analytics_Dashboard.png
│
...
Place `upi_transactions_2024.csv` in the project directory.

The dataset itself is not included in this repository because it is excluded through `.gitignore`.
...
* Build a Tableau dashboard for additional visualization
...
LinkedIn: [linkedin.com/in/rugved-nadhe-3a63132a1](https://www.linkedin.com/in/rugved-nadhe-3a63132a1)
